...
/**
 * Created by codingoliver on 11/6/2018.
 */
...
public class CustomSnackBar
{
    ...
    public static CustomSnackBar singleton;
    ...
    private static android.support.design.widget.Snackbar.SnackbarLayout snackLayout;

    public static CustomSnackBar with(Context context, View fab)
    {
        snackContext = context.getApplicationContext();
        if (singleton == null)
            singleton = new CustomSnackBar();
    ...
    public static CustomSnackBar type(Type type)
    {
        colorCode = Type.getColorCode(type);
        return singleton;
    }

    public static CustomSnackBar type(Type type, int color)
    {
        if (type == Type.CUSTOM)
            colorCode = color;
        else
    ...
    public static CustomSnackBar message(CharSequence displayingMessage)
    {
        snackMessage = displayingMessage.toString();
        return singleton;
    }

    public static CustomSnackBar duration(Duration duration)
    {
    ...
    public static CustomSnackBar duration(Duration durationType, int duration)
    {
    ...
    public static CustomSnackBar contentView(final View view, int heightInDp)
    {
        isCustomView = true;

        snackLayout = (android.support.design.widget.Snackbar.SnackbarLayout) snackbar.getView();
    ...
    public static CustomSnackBar fillParent(boolean fillParent)
    {
        isFillParent = fillParent;
        return singleton;
    }

    public static CustomSnackBar textAlign(Align align)
    {
        textAlign = align;
        return singleton;
    }
    ...
    private static CustomSnackBar setColor(int colorId)
    {
    ...
    public static void removeCustomView()
    {
        if (snackLayout != null && snackLayout.getChildAt(0) != null)
        {
            snackLayout.removeViewAt(0);
        }
    }
}
